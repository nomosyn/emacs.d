;;; nomosyn-theme.el --- Custom theme for faces
...
(deftheme nomosyn
  "Face colors using nomosyn settings.")
...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   ...
   `(default ((,class (:background "black" :foreground "gray80"))))
...
(provide-theme 'nomosyn)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; nomosyn-theme.el ends here
